...
void	TRIO_Unlock();
int	TRIO_Probe();
int	TRIO_ModeAvailable();
int	TRIO_SetMode(int Mode);
int	TRIO_SetLinearBuffer(int Start, int Length);
...
//
// Description:
//  Positions the video windows to the position
//  specified by start and being of specified
//  length.
//
void TRIO_SetLinearBuffer(int Start, int Length)
{
	TRIO_Unlock();
